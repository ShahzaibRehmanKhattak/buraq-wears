...
// Fully self-contained dummy data matching your custom data architecture
const DUMMY_SHOP_DATA = [
  {
    ...
    discountedPrice: 199,
    price: 299,
    imgs: { previews: ["/images/products/product-1-bg-1.png"] }
  },
  {
    id: 2,
    ...
    discountedPrice: 89,
    price: 120,
    imgs: { previews: ["/images/products/product-2-bg-1.png"] }
  },
  {
    id: 3,
    ...
    discountedPrice: 249,
    price: 349,
    imgs: { previews: ["/images/products/product-3-bg-1.png"] }
  },
  {
    id: 4,
    ...
    discountedPrice: 449,
    price: 599,
    imgs: { previews: ["/images/products/product-4-bg-1.png"] }
  },
  {
    id: 5,
    ...
    discountedPrice: 59,
    price: 79,
    imgs: { previews: ["/images/products/product-5-bg-1.png"] }
  },
  {
    id: 6,
    ...
    discountedPrice: 79,
    price: 110,
    imgs: { previews: ["/images/products/product-6-bg-1.png"] }
  }
];

/* ==========================================================================
   INTERNAL COMPONENT: SingleProductItem
   ========================================================================== */
const SingleProductItem = ({ item }) => {
  // Safe local mock interactions for clean developer parsing
  const handleQuickViewUpdate = () => console.log("QuickView item updated:", item);
  const handleAddToCart = () => console.log("Added to cart:", item);
  const handleItemToWishList = () => console.log("Added to wishlist:", item);

  return (
    <div className="group font-poppins">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px] flex flex-col justify-between pb-6">
        
        {/* Product Details Header */}
        <div className="text-center px-4 pt-7.5 pb-4">
          {/* Star Ratings Block */}
        ...
        {/* Product Preview Image Asset */}
        <div className="flex justify-center items-center px-4 mix-blend-multiply">
          <Image 
            src={item.imgs?.previews?.[0] || "/images/placeholder.png"} 
            alt={item.title || "Product Image"} 
            width={280} 
            height={280}
            className="object-contain max-h-[240px] w-auto transition-transform duration-300 group-hover:scale-105"
          />
        </div>

        {/* Floating Quick Actions Bar (Slides in on hover) */}
        <div className="absolute right-0 bottom-6 translate-x-full flex flex-col gap-2 p-4 ease-linear duration-300 group-hover:translate-x-0 z-20">
          
          {/* Quick View Trigger Button */}
          <button
            onClick={handleQuickViewUpdate}
            aria-label="Quick view product"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-sm ease-out duration-200 text-dark bg-white hover:text-white hover:bg-blue transition-colors"
          >
...
/* ==========================================================================
   PRIMARY EXPORT COMPONENT: BestSeller
   ========================================================================== */
const BestSeller = () => {
  return (
    <section className="overflow-hidden py-12 bg-white font-poppins">
      <div className="max-w-[1280px] w-full mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header Block */}
        <div className="mb-10 flex items-center justify-between">
          <div>
            <span className="flex items-center gap-2.5 font-medium text-dark mb-1.5 text-sm uppercase tracking-wider">
              <Image
                src="/images/icons/icon-07.svg"
                alt="calendar section icon"
                width={17}
                height={17}
              />
              This Month
            </span>
            <h2 className="font-semibold text-2xl lg:text-3xl text-dark tracking-tight">
              Best Sellers
            </h2>
          </div>
        </div>

        {/* Dynamic Products Grid using the built-in Mock Data array */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7.5">
          {DUMMY_SHOP_DATA.map((item) => (
        ...
        <div className="text-center mt-12.5">
          <Link
            ...
            className="inline-flex font-medium text-sm py-3 px-10 sm:px-12 rounded-md border-gray-3 border bg-gray-1 text-dark tracking-wide ease-out duration-200 hover:bg-dark hover:text-white hover:border-transparent transition-all"
          >
            View All Items
          </Link>
        </div>
