...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-white border-t border-neutral-100 font-poppins antialiased">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-6 xl:px-0">
        
        {/* ================= FOOTER MENU START ================= */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-16 xl:justify-between pt-16 pb-12">
          
          {/* Column 1: Help & Support */}
          <div className="max-w-[330px] w-full space-y-6">
            <h2 className="text-base font-bold text-neutral-900 tracking-wide uppercase">
              Help & Support
            </h2>

            <ul className="flex flex-col gap-4 text-sm text-neutral-600 font-normal leading-relaxed">
              ...
              <li>
                <a href="tel:+0995327869843" className="flex items-center gap-3 hover:text-[#3B51E3] transition-colors duration-200">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="mailto:support@example.com" className="flex items-center gap-3 hover:text-[#3B51E3] transition-colors duration-200">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 pt-2">
              {["Facebook", "Twitter", "Instagram", "Linkedin"].map((platform, index) => (
                <a
                  ...
                  className="text-neutral-400 hover:text-[#3B51E3] transition-colors duration-200"
                >
                  <svg
                    className="fill-current"
                    width={index === 0 ? "18" : "20"}
                    height={index === 0 ? "18" : "20"}
                    viewBox={index === 0 ? "0 0 18 18" : "0 0 20 20"}
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    {index === 0 && (
          ...
          <div className="w-full sm:w-auto space-y-6">
            ...
            <ul className="flex flex-col gap-3 text-sm text-neutral-600 font-normal">
              {["My Account", "Login / Register", "Cart", "Wishlist", "Shop"].map((item) => (
                <li key={item}>
                  <a className="hover:text-[#3B51E3] transition-colors duration-200" href="#">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div className="w-full sm:w-auto space-y-4 lg:text-right">
            <h2 className="text-base font-bold text-neutral-900 tracking-wide uppercase">
              Download App
            </h2>
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a
                  className="inline-flex items-center gap-3 py-2.5 pl-4 pr-6 text-white rounded-xl bg-neutral-950 hover:bg-neutral-800 transition-colors duration-200"
                  href="#"
                >
                  <svg
                    className="fill-current"
                  ...
                  <div className="text-left leading-none">
                    <span className="block text-[10px] text-neutral-400 font-normal">Download on the</span>
                    <p className="text-sm font-semibold tracking-wide">App Store</p>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-2.5 pl-4 pr-6 text-white rounded-xl bg-[#3B51E3] hover:bg-[#2c3ebb] transition-colors duration-200"
                  href="#"
                >
                  <svg
                    className="fill-current"
                  ...
                  <div className="text-left leading-none">
                    <span className="block text-[10px] text-blue-200 font-normal">Get it On</span>
      ...
      {/* ================= FOOTER BOTTOM START ================= */}
      <div className="py-6 bg-neutral-50 border-t border-neutral-100 text-sm text-neutral-600">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-6 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <p className="font-semibold text-neutral-800">We Accept:</p>

              <div className="flex flex-wrap items-center gap-5 opacity-80">
                {[
                  { id: "01", name: "visa card", w: 66, h: 22 },
                  { id: "02", name: "paypal", w: 18, h: 21 },
                  { id: "03", name: "master card", w: 33, h: 24 },
                  { id: "04", name: "apple pay", w: 53, h: 22 },
                  { id: "05", name: "google pay", w: 56, h: 22 }
                ].map((payment) => (
                  <a key={payment.id} href="#" aria-label={`payment system with ${payment.name}`}>
                    <Image
                      src={`/images/payment/payment-${payment.id}.svg`}
                      alt={payment.name}
                      width={payment.w}
                      height={payment.h}
