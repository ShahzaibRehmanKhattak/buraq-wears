      ...
      <div className="lg:col-span-6 flex flex-col justify-center max-w-[400px] mx-auto w-full">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="w-full h-11 px-4 border border-[#cfc4c5] bg-white text-black focus:border-[#3C50E0] focus:ring-0 transition-colors outline-none text-sm placeholder-[#7e7576]" 
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <Link href="/login/forgot-password" className="text-xs text-[#4c4546] hover:text-[#3C50E0] hover:underline transition-colors">Forgot password?</Link>
            </div>
            <input 
              type="password"
              required
          ...
          {/* Core Theme Accent Applied (#3C50E0) while retaining sizes */}
          <button 
            type="submit"
            disabled={loading}
            className="w-full h-12 bg-[#3C50E0] text-white text-sm font-semibold tracking-widest uppercase hover:opacity-90 transition-opacity active:scale-95 transition-transform mt-2 disabled:opacity-50"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-[#4c4546]">
            ...
            <Link className="text-[#3C50E0] font-semibold hover:underline" href="/register">Create Account</Link>
          </p>
        </div>
      </div>
