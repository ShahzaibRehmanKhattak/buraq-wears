      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-32">
          ...
          <div className="md:col-span-4 space-y-10">
            <Link href="/" className="font-display text-[24px] tracking-[-0.05em] text-black uppercase">
              IBNA ATELIER
            </Link>
            ...
            <div className="flex gap-6 text-[12px] font-bold uppercase tracking-widest">
              {['Instagram', 'Vimeo', 'LinkedIn'].map(social => (
                <a key={social} href={`https://${social.toLowerCase()}.com`} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors">
                  {social}
                </a>
              ))}
            </div>
          ...
          <div className="md:col-span-4 space-y-8">
            ...
            <p className="text-[14px] text-gray-500">
              Access early releases and exclusive insights into our seasonal narratives.
            </p>
            <form className="flex border-b border-black pb-2 group" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button type="submit" className="group-hover:translate-x-1 transition-transform">
                <ArrowRight size={18} />
              </button>
            </form>
          </div>
