...
export const Badge = ({ children, variant = "default" }) => {
  ...
  const styles = {
    /* Updated default style layer to map straight to your database parameters */
    default: "bg-[var(--bg-color)] text-[var(--primary)] border-[var(--primary)] border-opacity-10",
  ...
  return (
    <span 
      style={{ 
        borderRadius: "var(--radius)" // Dynamic corner matching (square vs rounded cut)
      }} 
      className={`
        /* Baseline Box Alignments */
        inline-flex items-center justify-center
        px-2.5 py-1 border text-[9px]
